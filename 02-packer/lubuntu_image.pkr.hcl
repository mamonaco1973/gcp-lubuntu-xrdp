# ==============================================================================
# PACKER BUILD: Lubuntu Image for GCP (Ubuntu 24.04 LTS)
# ------------------------------------------------------------------------------
# Purpose:
#   - Builds a custom Google Compute Engine image with Lubuntu + XRDP
...
source "googlecompute" "lubuntu_image" {
  ...
  image_name   = "lubuntu-image-${local.timestamp}"     # Unique image name per build
  image_family = "lubuntu-images"                       # Image family for versioned builds
...
build {
  sources = ["source.googlecompute.lubuntu_image"]
