...
secretValue=$(gcloud secrets versions access latest --secret="admin-ad-credentials-lubuntu")
...
chmod -R 775 gcp-lubuntu-xrdp
chgrp -R mcloud-users gcp-lubuntu-xrdp
